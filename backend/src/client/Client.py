...
from src.client.VerticalType import VerticalType
...
class Client:
    ...
    def __repr__(self) -> str:
        return (f"Contract(id={self.id}, name='{self.name}', idno='{self.idno}', "
                f"company_type='{self.company_type}', created_date={
                    self.created_date}, "
                f"vertical='{self.vertical}', address='{
                    self.address}', tva_code='{self.tva_code}', "
                f"bank_code='{self.bank_code}', bank_name='{
                    self.bank_name}', iban='{self.iban}', "
                f"bank_address='{self.bank_address}', fiscal_code='{
                    self.fiscal_code}', "
                f"person_id={self.person_id}, director_first_name='{
                    self.director_first_name}', "
                f"director_last_name='{
                    self.director_last_name}', country={self.country}, "
                f"email='{self.email}')")
